...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <form action="/admin/secondType" class="navbar-form navbar-left" target="context">
                <div class="form-group">
                    <select name="type" class="form-control">
                        <option value="gname" selected="selected">完成率</option>
                    </select>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="货物名称" name="gname">
                </div>
                <div class="form-group">
