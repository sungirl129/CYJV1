<%@ page import="com.cyj.tools.PageUtil" %>
...
<h3 style="text-align: center">货物信息</h3>
...
<p>
    ...
    <a href="/admin/search?pageNo=1">首页</a>
    <c:choose>
        <c:when test="${requestScope.nowPage.pageNumber > 1}"><a href="/admin/search?pageNo=${nowPage.pageNumber-1}">上一页</a></c:when>
        <c:otherwise>
            上一页
        </c:otherwise>
    </c:choose>
    <c:choose>
        <c:when test="${nowPage.pageNumber < nowPage.totalPage}"><a href="/admin/search?pageNo=${nowPage.pageNumber+1}">下一页</a></c:when>
        <c:otherwise>
            下一页
        </c:otherwise>
    </c:choose>
    <a href="/admin/search?pageNo=${nowPage.totalPage}">尾页</a>
</p>
</body>
</html>
