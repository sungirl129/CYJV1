...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <form action="/supplier/purchaseHistory?pageNum=1" id="stockForm" class="navbar-form navbar-left">
...
<div class="foot">
    <p>
        ...
        <a href="/supplier/purchaseHistory?pageNum=1">首页</a>
        <c:choose>
            <c:when test="${requestScope.nowPage.pageNumber > 1}"><a href="/supplier/purchaseHistory?pageNum=${nowPage.pageNumber-1}">上一页</a></c:when>
            <c:otherwise>
                上一页
            </c:otherwise>
        </c:choose>
        <c:choose>
            <c:when test="${nowPage.pageNumber < nowPage.totalPage}"><a href="/supplier/purchaseHistory?pageNum=${nowPage.pageNumber+1}">下一页</a></c:when>
            <c:otherwise>
                下一页
            </c:otherwise>
        </c:choose>
        <a href="/supplier/purchaseHistory?pageNum=${nowPage.totalPage}">尾页</a>
    </p>
</div>
</body>
</html>
